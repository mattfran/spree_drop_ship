  ...
  class SupplierAbility
    ...
    def initialize(user)
      ...
      if user.supplier
        ...
        can [:admin, :manage, :update], Spree::StockItem, stock_location_id: user.supplier.stock_locations.pluck(:id)
        can [:admin, :manage, :update], Spree::StockLocation, supplier_id: user.supplier_id
        can :create, Spree::StockLocation
        can [:admin, :manage, :update], Spree::StockMovement, stock_item: { stock_location_id: user.supplier.stock_locations.pluck(:id) }
